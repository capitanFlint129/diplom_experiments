...
class DQN(nn.Module):
    def __init__(
        ...
        self._action_embedding_size = action_embedding_size
    ...
    def forward(
        ...
        prev_action_embs = self.action_embedding(prev_action)
    ...
    def forward_step(
        ...
        if prev_action is None:
            prev_action_emb = torch.zeros(
                1, self._action_embedding_size, device=observation.device
            )
        else:
