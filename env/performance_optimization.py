...
class LlvmMcaEnv(CompilerEnv):
    ...
    def reset(self):
        ...
        for i in range(attempts):
            ...
            proc = subprocess.run(
                [
                    CLANG_BIN, O0, "--target=x86_64", "-emit-llvm", "-o", 
                    self._filepath,
                ],
    ...
    def step(self, action):
        ...
        return (rblock_throughput_before - rblock_throughput_after) / self._rblock_throughput_initial
