...
WANDB_PROJECT_NAME = "rl-compilers-DQN-fix-results-23-03"
...
class TrainConfig:
    ...
    patience: int = 4  # The (MAX) number of times to apply a series of transformations without observable change
    val_patience: int = 5
