...
class TrainConfig:
    ...
    lstm_hidden_size: int = 128  # The dimension of a fully connected layer
    action_embedding_size: int = 100
    # Learning
    ...
    replace: int = (
        500  # The number of iterations to run before replacing target network
    )
